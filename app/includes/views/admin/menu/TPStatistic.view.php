<div class="TPWrapper TPWrapper-long">
    <div id="tabs-statistic">
        <p class="TPMainTitle"><?php _e('Statistics', KPDPlUGIN_TEXTDOMAIN ); ?></p>
        <nav class="TPNavigation">
            <ul class="TPMainMenu">
                <li>
                    <a href="#tabs-report" class="TPMainMenuA">
                        <i class="icoItemNav ico-report"></i>
                        <span><?php _e('Earnings Report', KPDPlUGIN_TEXTDOMAIN ); ?></span>
                    </a>
                </li>
                <li>
                    <a href="#tabs-balance" class="TPMainMenuA">
                        <i class="icoItemNav ico-balance"></i>
                        <span><?php _e('Balance and Payouts', KPDPlUGIN_TEXTDOMAIN ); ?></span>
                    </a>
                </li>
            </ul>
        </nav>
        <div id="tabs-report">
            <div class="TPmainContent TP-BalanceContent">
                <p class="TP-SettingTitle"><?php _e('Earnings Report', KPDPlUGIN_TEXTDOMAIN ); ?></p>
                <p class="infoLittleReport">
                    <?php _e('Your Earnings Report for ', KPDPlUGIN_TEXTDOMAIN ); ?>
                    <span id="infoDateReport"><?php echo date_i18n( 'F Y', time() ); ?></span>
                </p>

                <div class="TP-ViewStatistics">
                    <label class="TP-ViewStatisticsDate">
                        <span><?php _e('Select month', KPDPlUGIN_TEXTDOMAIN ); ?></span>
                        <?php
                        global $wp_locale;
        ...
        <div id="tabs-balance">
            <div class="TPmainContent TP-BalanceContent">
                <p class="TP-SettingTitle"><?php _e('Balance and Payouts', KPDPlUGIN_TEXTDOMAIN ); ?></p>
                <p class="TP-OurBalance"><?php _e('Balance', KPDPlUGIN_TEXTDOMAIN ); ?>: <span>
