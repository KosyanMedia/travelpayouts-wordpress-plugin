<div class="TPWrapper TPWrapper-long">
    ...
    <p class="TPMainTitle  TPMainTitleSF">
        <?php _ex('Auto-links',
            'tp admin page auto links edit paragraph_1', TPOPlUGIN_TEXTDOMAIN); ?>
    </p>
    <div class="TP-TopImportantInfo TP-shortDescription">
        <p>
            <?php _ex('Here you can add referral links that you want to be defined to the specified anchor phrase.  Anchors are case-sensitive.',
                'tp admin page auto links edit paragraph_2', TPOPlUGIN_TEXTDOMAIN); ?>
        </p>
    </div>
    <div class="TPmainContent TP-BalanceContent TP-SettingContent">
        <p class="TP-SettingTitle">
            <?php _ex('Adding links',
                'tp admin page auto links edit paragraph_3', TPOPlUGIN_TEXTDOMAIN); ?>
        </p>
        ...
        <form method="post" action="admin.php?page=tp_control_substitution_links&action=update_link"
            ...
            <div class="TP-LocalHead TP-shortLocal TP-LocalHeadARL">
                <label id="TPArlUrl">
                    <span>
                        <?php _ex('Link',
                            'tp admin page auto links edit input arl url label', TPOPlUGIN_TEXTDOMAIN); ?>
                    </span>
                ...
                <label class="TP-inputTextShortCust">
                        <span>
                            <?php _ex('Anchor phrase',
                                'tp admin page auto links edit textarea arl anchor label', TPOPlUGIN_TEXTDOMAIN); ?>
                            <a href="#" class="tooltip-settings TPARLHelp">
                                <span>
                                     <?php _ex('You may add several anchors, use comma as separator',
                                         'tp admin page auto links edit textarea arl anchor label help', TPOPlUGIN_TEXTDOMAIN); ?>
                                </span>
                                <div class="svg-img-3">
                ...
                <label class="TP-LabelEvent">
                   <span>
                       <?php _ex('Events onclick',
                           'tp admin page auto links edit textarea arl event label', TPOPlUGIN_TEXTDOMAIN); ?>
                       <a href="#" class="tooltip-settings TPARLHelp">
                           <span>
                                <?php _ex('You can add here custom events (e.g. Google Analytics events) that will be fired after the click on a link',
                                    'tp admin page auto links edit textarea arl event label help', TPOPlUGIN_TEXTDOMAIN); ?>
                           </span>
                           <div class="svg-img-3">
                               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 1 15 15"><g fill="#00B0DD">
                                       <path d="M7.3 11.6c-.3 0-.5.2-.5.5v.4c0 .3.2.5.5.5s.5-.2.5-.5v-.4c.1-.2-.2-.5-.5-.5z"/>
                ...
                <label class="TP-inputTextShortCustCheck">
                    ...
                    <label for="chekarla1">
                        <?php _ex('Add "nofollow" attribute',
                            'tp admin page auto links edit input arl nofollow label', TPOPlUGIN_TEXTDOMAIN); ?>
                    </label>
                    ...
                    <label for="chekarla2">
                        <?php _ex('Replace existing links',
                            'tp admin page auto links edit input arl replace label', TPOPlUGIN_TEXTDOMAIN); ?>
                        <a href="#" class="tooltip-settings TPARLHelp">
                            <span>
                                <?php _ex('In case you already have such active links — they\'ll be replaced to the new one',
                                    'tp admin page auto links edit input arl replace label help', TPOPlUGIN_TEXTDOMAIN); ?>
                            </span>
                            <div class="svg-img-3">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 1 15 15"><g fill="#00B0DD">
                                        <path d="M7.3 11.6c-.3 0-.5.2-.5.5v.4c0 .3.2.5.5.5s.5-.2.5-.5v-.4c.1-.2-.2-.5-.5-.5z"/>
                    ...
                    <label for="chekarla3">
                        <?php _ex('Open in a new tab',
                            'tp admin page auto links edit input arl target blank label', TPOPlUGIN_TEXTDOMAIN); ?>
                    </label>
                </label>
            </div>
            <div class="TP-navsUserShort">
                <a href="admin.php?page=tp_control_substitution_links" class="TP-deleteShortLincks TP-deleteShortLincks--cust">
                    <i></i>
                    <?php _ex('cancel',
                        'tp admin page auto links edit btn cancel label', TPOPlUGIN_TEXTDOMAIN); ?>
                </a>
                <button class="TP-BtnTab">
                    <?php _ex('save changes',
                        'tp admin page auto links edit btn save changes label', TPOPlUGIN_TEXTDOMAIN); ?>
                </button>
            </div>
        </form>
    </div>
