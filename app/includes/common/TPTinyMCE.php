...
class TPTinyMCE
{
    ...
    public function __construct()
    {
        ...
        if (is_admin() && in_array($page, $this->usePages)) {
            add_action('init', [&$this, 'setupTinyMCE']);
            add_action('admin_print_scripts', [&$this, 'setupJSTinyMCE']);
            add_action('admin_print_footer_scripts', [&$this, 'addQuicktags']);
        }
    }

    public function setupTinyMCE()
    {
        add_filter('mce_external_plugins', [&$this, 'addTinyMCE']);
        add_filter('mce_buttons', [&$this, 'addTinyMCEToolbar']);
    }
    ...
    public function setupJSTinyMCE()
    {
        ...
        <script type="text/javascript">
            var linkShortcode, linkShortcodeBtnLabel, linkShortcodeAttrTitleValue, buttonShortcode,
                buttonShortcodeBtnLabel,
