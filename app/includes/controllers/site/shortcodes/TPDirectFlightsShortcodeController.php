...
class TPDirectFlightsShortcodeController extends \app\includes\controllers\site\TPShortcodesController{
    public $model;
    public $view;
    ...
    public function initShortcode()
    {
        ...
        add_shortcode( 'tp_direct_flights_shortcodes', array(&$this, 'actionTable'));
        add_shortcode( 'tp_direct_flights_shortcodes_max_price', array(&$this, 'actionMaxPrice'));
        add_shortcode( 'tp_direct_flights_shortcodes_min_price', array(&$this, 'actionMinPrice'));
    }
