...
class TPCheapestTicketEachDayMonthShortcodeController extends \app\includes\controllers\site\TPShortcodesController{
    ...
    public function initShortcode()
    {
        ...
        add_shortcode( 'tp_cheapest_ticket_each_day_month_shortcodes', array(&$this, 'actionTable'));
        add_shortcode( 'tp_cheapest_ticket_each_day_month_shortcodes_max_price', array(&$this, 'actionMaxPrice'));
        add_shortcode( 'tp_cheapest_ticket_each_day_month_shortcodes_min_price', array(&$this, 'actionMinPrice'));
    }
