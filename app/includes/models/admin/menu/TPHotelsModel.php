...
class TPHotelsModel extends TPBaseShortcodeOptionModel
{
    ...
    public function create_option()
    {
        ...
        add_settings_field('tp_hotels_shortcode_1_td', '', [&$field ,'TPFieldShortcode_1'],
        ...
        add_settings_field('tp_hotels_shortcode_2_td', '', [&$field ,'TPFieldShortcode_2'],
        ...
        add_settings_field('tp_hotels_shortcode_3_td', '', [&$field ,'TPFieldShortcode_3'],
        ...
        add_settings_field('tp_hotels_shortcode_4_td', '', [&$field ,'TPFieldShortcode_4'],
        ...
        add_settings_field('tp_hotels_shortcode_5_td', '', [&$field ,'TPFieldShortcode_5'],
        ...
        add_settings_field('tp_hotels_shortcode_6_td', '', [&$field ,'TPFieldShortcode_6'],
        ...
        add_settings_field('tp_hotels_themes_table_td', '', [&$field ,'TPFieldHotelsThemesTable'],
