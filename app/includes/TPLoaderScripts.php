...
use core\TPOLoaderScripts;

class TPLoaderScripts extends TPOLoaderScripts{

    public function __construct(){
        parent::__construct();
        if ( ! is_admin() ) {
            add_filter('script_loader_tag', [&$this, 'addAttrScript'], 200, 3);
        }
    ...
    public function headScriptAdmin()
    {
        ...
        <script type="text/javascript">
            ...
            TPHotelSelectWidgetCat1 = '<?php echo TPPlugin::$options['widgets'][7]['cat1']; ?>';
            TPHotelSelectWidgetCat2 = '<?php echo TPPlugin::$options['widgets'][7]['cat2']; ?>';
            TPHotelSelectWidgetCat3 = '<?php echo TPPlugin::$options['widgets'][7]['cat3']; ?>';
            ...
            <?php
                if(  ! isset( TPPlugin::$options['account']['marker'] ) || empty( TPPlugin::$options['account']['marker'] )) {
                    ?>
    ...
    public function loadScriptSiteFontStyle(){
        if(TPPlugin::$options['themes_table']['name'] === 'default-theme'){
            if(TPPlugin::$options['style_table']['title_style']['font_family'] === 'Roboto' ||
                TPPlugin::$options['style_table']['table']['font_family'] === 'Roboto') {
                wp_register_style(
            ...
            } elseif (TPPlugin::$options['style_table']['title_style']['font_family'] === 'Roboto Slab' ||
                TPPlugin::$options['style_table']['table']['font_family'] === 'Roboto Slab'){
                wp_register_style(
            ...
            } elseif (TPPlugin::$options['style_table']['title_style']['font_family'] === 'Ubuntu' ||
                TPPlugin::$options['style_table']['table']['font_family'] === 'Ubuntu'){
                wp_register_style(
            ...
            } elseif (TPPlugin::$options['style_table']['title_style']['font_family'] === 'Intro' ||
                TPPlugin::$options['style_table']['table']['font_family'] === 'Intro'){
                //TPFontsIntro
                wp_register_style(
            ...
            elseif (TPPlugin::$options['style_table']['title_style']['font_family'] === 'Open Sans' ||
                TPPlugin::$options['style_table']['table']['font_family'] === 'Open Sans'){
                wp_register_style(
            ...
            switch (TPPlugin::$options['themes_table']['name']){
                //1
                case 'default-theme':
	...
	public function loadScriptSiteThemeHotel(){
		switch (TPPlugin::$options['themes_table_hotels']['name']){
			case 'default-theme':
				wp_register_style(
    ...
    public function loadScriptSite($hook)
    {
       ...
       //     false === $this->isShortcodePost($post, '[tp') && !is_home() &&
        ...
        wp_register_style(
            ...
            [TPOPlUGIN_SLUG.'-fontello', TPOPlUGIN_SLUG.'-animation'], //$deps,
            $version // $ver
        );
    ...
    public function headScriptSite()
    {
        ...
        <script type="text/javascript">
            ...
            tpLocale = '<?php echo TPLang::getLang();?>';
        </script>
        <style type="text/css">
            .tp-pika-link{
                display: block;
            ...
            <?php
                if(isset(TPPlugin::$options['style_table']['table']['responsive'])){
                    ?>
                    .TP-Plugin-Tables_box {
                        display: block !important;
                        overflow-x: auto !important;
                        border: none !important;
                        border-left: <?php echo TPPlugin::$options['style_table']['table']['line_size']; ?>px <?php echo TPPlugin::$options['style_table']['table']['line_type']; ?> <?php echo TPPlugin::$options['style_table']['table']['line_color']; ?> !important;
                    }
            ...
            <?php if(TPPlugin::$options['themes_table']['name'] === 'default-theme'): ?>
                .TP-tdContent a{
                ...
                .TP-Plugin-Tables_box tbody tr:nth-child(even) td p:after {
                    background: transparent linear-gradient(to right, rgba(242, 242, 242, 0), <?php echo TPPlugin::$options['style_table']['table']['background_color']; ?>) repeat scroll 0% 0%;
                }
                .TPAirlineLogoTD{
                ...
                .TP-Plugin-Tables_box thead tr td{
                    background: <?php echo TPPlugin::$options['style_table']['table']['head_color']; ?>;
                }
                @media (max-width: 480px){
                    .TP-Plugin-Tables_box tbody tr td:before {
                        background: <?php echo TPPlugin::$options['style_table']['table']['head_color']; ?> !important;
                        color: <?php echo TPPlugin::$options['style_table']['table']['head_text_color']; ?> !important;
                    }
                    .TP-Plugin-Tables_box tbody tr td {
                ...
                .TP-Plugin-Tables_box thead tr td.TP-active {
                    background: <?php echo $this->ak_convert_hex2rgba(TPPlugin::$options['style_table']['table']['head_color'], 1); ?>;
                   /* box-shadow: 0 0 44px rgba(0,0,0,0.3) inset;  */
                }


                .TP-Plugin-Tables_box thead tr td {
                    color: <?php echo TPPlugin::$options['style_table']['table']['head_text_color']; ?>;
                }



                a.paginate_button.current {
                    border-color: <?php echo TPPlugin::$options['style_table']['table']['head_color']; ?>;
                    background: <?php echo TPPlugin::$options['style_table']['table']['head_color']; ?>;
                    color:  <?php echo TPPlugin::$options['style_table']['table']['head_text_color']; ?>;
                }
                a.paginate_button:hover {
                    ...
                    cursor: pointer;
                    color: <?php echo TPPlugin::$options['style_table']['table']['head_color']; ?> !important;
                }
                ...
                .TP-Plugin-Tables_box tbody tr td .TP-Plugin-Tables_link {
                    border-bottom: 1px solid <?php echo TPPlugin::$options['style_table']['button']['border']; ?> !important;
                    background: <?php echo TPPlugin::$options['style_table']['button']['background']; ?> !important;
                    color:  <?php echo TPPlugin::$options['style_table']['button']['color']; ?> !important;
                    <?php
                       if(isset(TPPlugin::$options['style_table']['button']['font_style']['bold'])){
                           echo 'font-weight: bold !important;';
                       }else{
                           echo 'font-weight: normal !important;';
                       }
                       if(isset(TPPlugin::$options['style_table']['button']['font_style']['italic'])){
                           echo 'font-style: italic !important;';
                       }else{
                           echo 'font-style: normal !important;';
                       }
                       if(isset(TPPlugin::$options['style_table']['button']['font_style']['underline'])){
                           echo 'text-decoration: underline !important;';
                       }else{
                           echo 'text-decoration: none !important;';
                       }
                ...
                .TP-Plugin-Tables_box tbody tr td .TP-Plugin-Tables_link:hover {
                    background: <?php echo $this->ak_convert_hex2rgba(TPPlugin::$options['style_table']['button']['background'], 0.7); ?> !important;
                }
            <?php endif; ?>
        </style>
    <?php
    ...
    public function footerScriptSite()
    {
        ...
        ?>
        <script type="text/javascript">
            <?php if(!empty(TPPlugin::$options['config']['code_ga_ym'])){?>
            jQuery(function($) {
                var doc, win;
                doc = $(document);
                doc.find('.TPButtonTable').click(function () {
                    <?php echo TPPlugin::$options['config']['code_ga_ym']; ?>
                });
            });
            <?php }?>
            <?php if(!empty(TPPlugin::$options['config']['code_table_ga_ym'])){?>
            jQuery(function($) {
                var doc, win;
                doc = $(document);
                doc.ready(function () {
                    $(window).load(function() {
                        doc.find('.TPTableShortcode').each(function( index ) {
                            <?php echo TPPlugin::$options['config']['code_table_ga_ym']; ?>
                        });
    ...
    public function isScriptSite(){
        global $post;
        $isScript = false;
        if (isset(TPPlugin::$options['config']['limit_script'])) {
