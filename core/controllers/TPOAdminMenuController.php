...
abstract class TPOAdminMenuController extends TPOBaseController{
    ...
    public function TPLinkHelp(){
        ...
        $body = '%0A%0A%0A%0A%0A'
            ...
            ._x('marker:',
                'tp_admin_page_link_help__msg_text_3', TPOPlUGIN_TEXTDOMAIN). TPPlugin::$options['account']['marker'].'%0A'
            ._x('whitelabel:',
                'tp_admin_page_link_help__msg_text_4', TPOPlUGIN_TEXTDOMAIN). TPPlugin::$options['account']['white_label'].'%0A'
            ._x('WP theme:',
